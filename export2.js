...
function processItem(i){
  ...
  inter = setInterval(function(){					
    ...
    if(typeof memo_fill != 'undefined') {
      ...
      result.push( [  url_fill.value, title_fill.value, username_fill.value, "" , password_fill.value,""]);	// add values to results array to be converted into csv file. Empty values should be empty strings, don't use null or leave blank
    }
